...
import averin.sirs_rskg.com.DaftarPoli;
...
public class JadwalDokterDSBAdapter extends RecyclerView.Adapter<JadwalDokterDSBAdapter.JadwalDokterViewHolder> {
    ...
    private String strFoto,jam_konvert_awal,jam_konvert_akhir,jam_awal,jam_akhir;
...
//        holder.txt_tglPeriksa.setText(list.get(position).getJam_mulai() +" WIB");
        ...
        holder.txt_tglPeriksa.setText(jam_konvert_awal+" - "+jam_konvert_akhir);
